<div class="col-md-6">
    @include('inc.alert')
    <form role="form" wire:submit.prevent="questionEight" method="post">
        ...
        <hr>
        <div class="form-group">
            <button wire:target="questionEight" wire:loading.attr="disabled" class="btn btn-outline-primary pull-right" type="submit">
                <div wire:loading>
