<div class="col-md-6">
    @include('inc.alert')
    <form role="form" wire:submit.prevent="questionNine" method="post">
        ...
        <hr>
        <div class="form-group">
            <button wire:target="questionNine" wire:loading.attr="disabled" class="btn btn-outline-primary pull-right"
                    type="submit">
                <div wire:loading>
